...
execute join(['function! vital#_caw#Vim#Vim9context#import() abort', printf("return map({'get_context': '', 'context': '', 'get_context_pos': ''}, \"vital#_caw#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
